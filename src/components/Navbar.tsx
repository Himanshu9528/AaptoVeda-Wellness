...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#f8f9fa]/90 dark:bg-[#121614]/90 backdrop-blur-xl border-b border-[#c1c8c2]/30 dark:border-[#274e3d]/40 transition-colors duration-300">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 py-3.5 flex items-center">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative hidden sm:block">
            <input
              ...
              className="bg-[#edeeef] dark:bg-[#1b4332]/60 text-[#191c1d] dark:text-[#f0f1f2] text-xs font-medium rounded-full px-4 py-2 pl-4 pr-9 w-40 md:w-52 lg:w-60 focus:outline-none focus:ring-2 focus:ring-[#012d1d] dark:focus:ring-[#c1ecd4] transition-all"
            />
          ...
          <button
            ...
            className="sm:hidden p-2 rounded-full text-[#012d1d] dark:text-[#c1ecd4] hover:bg-gray-200 dark:hover:bg-[#1b4332]"
            aria-label="Search"
          >
          ...
          <button
            onClick={onOpenQuiz}
            className="hidden sm:flex items-center gap-1.5 text-xs font-semibold px-3.5 py-1.5 rounded-full bg-[#cba72f]/15 text-[#735c00] dark:text-[#ffe088] border border-[#cba72f]/40 hover:bg-[#cba72f]/25 transition-all"
      ...
      {showSearchInput && (
        <div className="sm:hidden px-4 pb-3 pt-1 border-t border-[#c1c8c2]/20">
